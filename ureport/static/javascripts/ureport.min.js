...
var pie_opts={chart:{renderTo:"pie",margin:[5,5,5,5]},title:{text:""},plotArea:{shadow:!0,borderWidth:30,backgroundColor:null},tooltip:{formatter:function(){return"<b>"+this.point.name+"</b>: "+this.y.toFixed(1)+" %"}},plotOptions:{pie:{allowPointSelect:!0,cursor:"pointer",dataLabels:{enabled:!0,formatter:function(){},color:"white",style:{font:"13px Trebuchet MS, Verdana, sans-serif"}}}},legend:{layout:"horizontal",style:{left:"auto",bottom:"auto",right:"10px",top:"525px"}},credits:!1,subtitle:{text:""},
