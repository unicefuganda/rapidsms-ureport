...
function select_everything(a){$("#input_select_everything").val("true");$("#span_select_everything").html(gettext("All ")+a+gettext(' items are selected.')+' <a href="javascript:void(0)" onclick="deselect_everything('+a+')">'+ gettext('Clear selection')+'</a>')}
