...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExportedPoll'
        db.create_table('ureport_exportedpoll', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['poll.Poll'], unique=True)),
            ('exported_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('ureport', ['ExportedPoll'])


    def backwards(self, orm):
        # Deleting model 'ExportedPoll'
        db.delete_table('ureport_exportedpoll')
    ...
    models = {
        ...
        'ureport.exportedpoll': {
            'Meta': {'object_name': 'ExportedPoll'},
            'exported_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'poll': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['poll.Poll']", 'unique': 'True'})
        },
        'ureport.flagtracker': {
            'Meta': {'object_name': 'FlagTracker'},
            'flag': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contact.Flag']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flag_track'", 'to': "orm['rapidsms_httprouter.Message']"}),
            'reply': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'reply_track'", 'to': "orm['rapidsms_httprouter.Message']"}),
            'response': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'response_track'", 'null': 'True', 'to': "orm['rapidsms_httprouter.Message']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'ureport.ignoredtags': {
        ...
        'ureport.uploadcontacts': {
            'Meta': {'object_name': 'UploadContacts'},
            ...
            'unprocessed': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
