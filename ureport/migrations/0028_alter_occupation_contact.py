...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        if db_table_field_exists("rapidsms_contact","occupation"):
            db.alter_column('rapidsms_contact', 'occupation', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
        else:
            db.add_column('rapidsms_contact', 'occupation', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
