...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'PollAttribute', fields ['key_default', 'key']
        db.delete_unique('ureport_pollattribute', ['key_default', 'key'])
        ...
        # Deleting field 'PollAttribute.key_default'
        db.delete_column('ureport_pollattribute', 'key_default')

        # Deleting field 'PollAttribute.value'
        db.delete_column('ureport_pollattribute', 'value')

        # Deleting field 'PollAttribute.poll'
        db.delete_column('ureport_pollattribute', 'poll_id')

        # Adding field 'PollAttribute.default'
        db.add_column('ureport_pollattribute', 'default', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True), keep_default=False)
        ...
        # Adding unique constraint on 'PollAttribute', fields ['key']
        db.create_unique('ureport_pollattribute', ['key'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PollAttribute', fields ['key']
        db.delete_unique('ureport_pollattribute', ['key'])

        # Deleting model 'PollAttributeValue'
        db.delete_table('ureport_pollattributevalue')

        # Adding field 'PollAttribute.key_default'
        db.add_column('ureport_pollattribute', 'key_default', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True), keep_default=False)

        # We cannot add back in field 'PollAttribute.value'
        raise RuntimeError(
            "Cannot reverse this migration. 'PollAttribute.value' and its values cannot be restored.")

        # We cannot add back in field 'PollAttribute.poll'
        raise RuntimeError(
            "Cannot reverse this migration. 'PollAttribute.poll' and its values cannot be restored.")

        # Deleting field 'PollAttribute.default'
        db.delete_column('ureport_pollattribute', 'default')
        ...
        # Adding unique constraint on 'PollAttribute', fields ['key_default', 'key']
        db.create_unique('ureport_pollattribute', ['key_default', 'key'])
