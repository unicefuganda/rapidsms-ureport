...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UploadContacts.processed'
        db.delete_column('ureport_uploadcontacts', 'processed')

        # Adding field 'UploadContacts.unprocessed'
        db.add_column('ureport_uploadcontacts', 'unprocessed',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UploadContacts.processed'
        db.add_column('ureport_uploadcontacts', 'processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UploadContacts.unprocessed'
        db.delete_column('ureport_uploadcontacts', 'unprocessed')
