...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UploadContacts'
        db.create_table('ureport_uploadcontacts', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('excel_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('processed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('processed_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('ureport', ['UploadContacts'])


    def backwards(self, orm):
        # Deleting model 'UploadContacts'
        db.delete_table('ureport_uploadcontacts')
