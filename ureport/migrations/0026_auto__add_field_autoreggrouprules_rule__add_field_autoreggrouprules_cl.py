...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AutoregGroupRules.rule'
        db.add_column('ureport_autoreggrouprules', 'rule',
                      self.gf('django.db.models.fields.IntegerField')(max_length=10, null=True),
                      keep_default=False)

        # Adding field 'AutoregGroupRules.closed'
        db.add_column('ureport_autoreggrouprules', 'closed',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AutoregGroupRules.rule_regex'
        db.add_column('ureport_autoreggrouprules', 'rule_regex',
                      self.gf('django.db.models.fields.CharField')(max_length=700, null=True),
                      keep_default=False)


        # Changing field 'AutoregGroupRules.values'
        db.alter_column('ureport_autoreggrouprules', 'values', self.gf('django.db.models.fields.TextField')(null=True))
    def backwards(self, orm):
        # Deleting field 'AutoregGroupRules.rule'
        db.delete_column('ureport_autoreggrouprules', 'rule')

        # Deleting field 'AutoregGroupRules.closed'
        db.delete_column('ureport_autoreggrouprules', 'closed')

        # Deleting field 'AutoregGroupRules.rule_regex'
        db.delete_column('ureport_autoreggrouprules', 'rule_regex')


        # User chose to not deal with backwards NULL issues for 'AutoregGroupRules.values'
        raise RuntimeError("Cannot reverse this migration. 'AutoregGroupRules.values' and its values cannot be restored.")
    models = {
        'auth.group': {
