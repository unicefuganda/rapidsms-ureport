...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ureport_flagtracker', (
            ...
            ('message', self.gf('django.db.models.fields.related.ForeignKey')(related_name='flag_track', to=orm['rapidsms_httprouter.Message'])),
            ('response', self.gf('django.db.models.fields.related.ForeignKey')(related_name='response_track', null=True, to=orm['rapidsms_httprouter.Message'])),
            ('reply', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reply_track', to=orm['rapidsms_httprouter.Message'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('flag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contact.Flag'])),
        ))
        db.send_create_signal('ureport', ['FlagTracker'])


    def backwards(self, orm):
        # Deleting model 'FlagTracker'
        db.delete_table('ureport_flagtracker')
