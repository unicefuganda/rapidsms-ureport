...
urlpatterns = patterns('',
                       ...
                       url(r"^api/v1/ureporters/(?P<backend>\w+)/(?P<user_address>.*)$", ViewUReporter.as_view(),
                       ...
                       url(
                           r"^api/v1/ureporters/(?P<backend>\w+)/(?P<user_address>.*)/poll/(?P<poll_id>\d+)/responses/$",
                           SubmitPollResponses.as_view(), name="submit_poll_response_api"),
                       url(r"^api/v1/ureporters/(?P<backend>\w+)/(?P<user_address>.*)/polls/topics$",
                           PollTopicsApiView.as_view(), name="poll_topics_api"),
                       url(r"^api/v1/ureporters/(?P<backend>\w+)/(?P<user_address>.*)/reports/$",
                           SubmitReportApiView.as_view(), name="submit_report_api"),
                       url(r"^api/v1/ureporters/(?P<backend>\w+)/(?P<user_address>.*)/poll/(?P<poll_id>\d+)/summary$", PollSummary.as_view()),
